...
type ChainConfig struct {
	...
	ContractXChainECRecoverConfig	precompile.ContractXChainECRecoverConfig   `json:"contractXChainECRecover,omitempty"` 
}
...
func (c *ChainConfig) IsXChainECRecoverAllowList(blockTimestamp *big.Int) bool {
...
func (c *ChainConfig) AvalancheRules(blockNum, blockTimestamp *big.Int) Rules {
	...
	rules.IsContractXChainECRecoverEnabled = c.IsXChainECRecoverAllowList(blockTimestamp)
